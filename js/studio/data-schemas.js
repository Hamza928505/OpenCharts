...
export const DATA_SCHEMAS = {
  ...
  ...Object.fromEntries([
    ...
    sampleNote: 'Values are sampled from the distribution settings below. Switch to “My data” to paste real observations.',
    hideGroups: ['Data'],
    clearKeys: [],
  ...
  'scatter-basic': {
    ...
    sampleNote: 'Points are generated from the settings below. Switch to “My data” to paste x,y pairs.',
    hideGroups: ['Data'],
  ...
  ...Object.fromEntries(['ohlc', 'candlestick', 'renko', 'point-figure', 'kagi'].map((id) => [id, {
    ...
    sampleNote: 'Prices are simulated from the settings below. Switch to “My data” to paste real OHLC rows.',
    hideGroups: ['Data'],
    clearKeys: ['bars'],
    toText: (s) => (s.bars
  ...
  'horizon-chart': {
    ...
    sampleNote: 'Signals are generated per row. Switch to “My data” to paste real series.',
    hideGroups: ['Data'],
    clearKeys: [],
  ...
  'spiral-plot': {
    ...
    sampleNote: 'Values are generated from the settings below. Switch to “My data” to paste a real series.',
    hideGroups: ['Data'],
    clearKeys: ['values'],
  ...
  'calendar-heatmap': {
    ...
    sampleNote: 'Daily counts are generated. Switch to “My data” to paste real dates.',
    hideGroups: ['Data'],
    clearKeys: ['dayValues'],
  ...
  'radial-histogram': {
    ...
    sampleNote: 'Counts are generated from the settings below. Switch to “My data” to paste real bins.',
    hideGroups: ['Data'],
    clearKeys: ['binCounts'],
  ...
  'heatmap': {
    ...
    sampleNote: 'Cells are generated from the settings below. Switch to “My data” to paste a grid.',
    hideGroups: ['Data'],
    clearKeys: ['cells'],
  ...
  'parallel-coords': {
    ...
    sampleNote: 'Items are generated. Switch to “My data” to paste a real table.',
    hideGroups: ['Data'],
    clearKeys: ['records'],
    toText: (s) => (s.records
  ...
  ...Object.fromEntries(['choropleth', 'cartogram', 'dot-density-map'].map((id) => [id, {
    ...
    sampleNote: 'Values are generated per country. Switch to “My data” to paste real figures.',
    hideGroups: ['Data'],
